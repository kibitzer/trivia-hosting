...
** NOTE **
This is not intended to be robust or production-ready. This is a simple no-build project designed to:
1. tease out features for a Trivia HOsting system
2. test out the capabilities of AI coding
