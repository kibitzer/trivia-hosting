...
document.addEventListener('alpine:init', () => {
    Alpine.data('triviaHost', () => ({
        ...
        // Quiz Data
        quizData: [],
        filename: 'EOY-2025.json', // Default selection
        customFilename: '',
        
        // Game State
        currentView: 'setup', // 'setup', 'game'
        currentIndex: -1,
        timerValue: 20,
        defaultTimer: 20,
        timerStatus: 'stopped', // 'stopped', 'countdown', 'running', 'ended', 'revealed'
        ...
        // --- Computed Properties (Simulated as getters) ---
        get playerList() {
        ...
        get onlinePlayerCount() {
            return Object.values(this.players).filter(p => p.online).boolean;
        },
        ...
        get currentQuestionAnswers() {
            ...
            return Object.entries(answers).map(([playerId, data]) => ({
                ...
                // Check correctness for display styling
        ...
        nextItem() {
            if (this.currentIndex < this.quizData.length - 1) {
                ...
                // Auto-start countdown for questions
                if (this.currentItem.type === 'question') {
                    this.startCountdown();
                }
            }
        ...
        startCountdown() {
            ...
            this.timerValue = preCount; // Show "Starting in 3..." logic visually handled by UI text binding? 
            // Actually, let's just use the value directly
        ...
        startMainTimer() {
            ...
            // Reset to question specific time
        ...
        checkAutoReveal() {
            ...
            // Count online players vs answers
